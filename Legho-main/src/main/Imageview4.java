...
public class Imageview4 extends Application {
	Stage stage;
	Scene iv1Page;
	BorderPane bp;
	GridPane gp;
	...
	public void iv1Page() {
		ImageView iv1 = new ImageView(new Image(getClass().getResourceAsStream("/assets/lego4.png")));
		Text description = new Text("Captivate fans of travel, history or architecture with the new LEGHO Eiffel tower");
		bp = new BorderPane();
		gp = new GridPane();
		button1 = new HBox();
		button2 = new HBox();
