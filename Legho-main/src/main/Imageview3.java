...
public class Imageview3 extends Application {
	Stage stage;
	Scene iv1Page;
	BorderPane bp;
	GridPane gp;
	...
	public void iv1Page() {
		ImageView iv1 = new ImageView(new Image(getClass().getResourceAsStream("/assets/lego3.png")));
		Text description = new Text("LEGHO feature the iconic Mickey Mouse");
		bp = new BorderPane();
		gp = new GridPane();
		button1 = new HBox();
		button2 = new HBox();
