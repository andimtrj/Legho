...
public class Imageview1 extends Application {
	...
	public void iv1Page() {
		...
		Text description = new Text("Capture the scale and power of the Hulkbuster MK44 with this 4,049-piece, \n authentically detailed movable model, standing over 52 cm (20.5 in.) tall");
		bp = new BorderPane();
		gp = new GridPane();
		button1 = new HBox();
		button2 = new HBox();
